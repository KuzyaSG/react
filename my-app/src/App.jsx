...
function App() {
    ...
    React.useEffect(() => {
        ...
        async function axiosData(){
            ...
            const tyrsData = await axios.get('https://639b863131877e43d68e63af.mockapi.io/tyrs')
            const cartData = await axios.get('https://639b863131877e43d68e63af.mockapi.io/cart')
            const favoritesData = await axios.get('https://639b863131877e43d68e63af.mockapi.io/favorites')
    ...
    const deleteItems=(id)=>{
        console.log(id);
        axios.delete(`https://639b863131877e43d68e63af.mockapi.io/cart/${id}`)
